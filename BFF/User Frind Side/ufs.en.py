...
driver.get('https://bffstag.lolzz.me/en/accept/OWgtD')
...
time.sleep(2)
driver.find_elements_by_css_selector('div[data-file-id="347"]')[0].click()
time.sleep(2)
driver.find_element(By.CSS_SELECTOR,'div[value="More than four"]').click()
time.sleep(2)
driver.find_elements_by_css_selector('div[data-file-id="353"]')[0].click()
time.sleep(2)
...
time.sleep(2)
driver.find_elements_by_css_selector('div[data-file-id="363"]')[0].click()

time.sleep(2)
driver.find_elements_by_css_selector("div[value='March']")[0].click()
time.sleep(2)

driver.find_elements_by_css_selector('div[data-file-id="378"]')[0].click()
