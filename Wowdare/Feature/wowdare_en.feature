Feature:  Wowdare User Side End to End Functionality
  ...
  @home_page
  Scenario: To check the functionality of the Name field With Valid Data & Invalid Data.
  ...
  Given  Validate onesignal pop-up With click on Later Button
  When   Click On Q1
  And    Click On Q2
  And    Click On Q3
  And    Click On Q4
  ...
  And    Click On Q14
   ...
   @question_Page
  Scenario: To check the functionality of Skip Button And  Navigate To Share Page
 ...
 @Answer_page
  ...
  And    User Friend Validate onesignal pop-up With click on Later Button
